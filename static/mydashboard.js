...
// Chargement des données météo et formatage du graphe de visualisation grace a la librairie nvd3
    ...
    if (data["status"] == "ok") {
        ...
        nv.addGraph(function() {
            ...
            var chart = nv.models.lineWithFocusChart()
                ...
                .yDomain([-5, 35])
                .height(270)
                .color(colors);// colors ici est la variable colors que nous avons definis au debut du programme
            ...
            chart.y2Axis
                .showMaxMin(false)
                .ticks(false);
           //Element svg qui va acceuillir le graphe,#meteo represente la div qui contient lelement svg
            d3.select('#meteo svg')
                .datum(temperature_data)//VARIABLE CONTENANT LES DONNEES
                .call(chart);//GRAPHE PARAMETRE AVEC NOS DONNEES DE PERSONNALISATION 
